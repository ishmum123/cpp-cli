...
all: clean runner cli

cli: $(SRC_DIR)/main.cpp  runner
	g++ $(SRC_DIR)/main.cpp --std=$(STD) $(RFL_DIR)/rfl/thirdparty/yyjson.c -I$(RFL_DIR) $(BUILD_DIR)/runner.o $(LDLIBS) -o $(BUILD_DIR)/cli 
